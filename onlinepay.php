                    ...
                    <div class="panel-heading">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-3">
                                <input type="text" class="form-control" placeholder="0000" pattern="[0-9][0-9][0-9][0-9]" required>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-3">
                                <input type="text" class="form-control" placeholder="0000" pattern="[0-9][0-9][0-9][0-9]" required>
                            </div>
                        ...
                        <div class="row ">
                            <div class="col-md-3 col-sm-3 col-xs-3">
                                ...
                                <input type="text" class="form-control" placeholder="MM" pattern="[1-12]" required>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-3">
                                <span class="help-block text-muted small-font">  Expiry Year</span>
                                <input type="text" class="form-control" placeholder="YY" pattern="[21-28]" required>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-3">
                                <span class="help-block text-muted small-font">  CCV</span>
                                <input type="text" class="form-control" placeholder="CCV" pattern="[0-9][0-9][0-9]" required/>
                            </div>
