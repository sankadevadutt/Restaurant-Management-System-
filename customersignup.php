      ...
      <div class="panel panel-primary">
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
            <input class="form-control" id="mobile" type="tel" name="mobile" placeholder="10-digit mobile number initial digit from [6-9]" pattern="[6-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]" required="">
              <span class="input-group-btn">
